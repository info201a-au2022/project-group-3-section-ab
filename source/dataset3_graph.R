...
mean_8 <- calculate_mean(gestation_8_duration, filter_ca(gestation_8_duration))
mean_8_closed <- calculate_mean(gestation_8_duration_closed, filter_ca(gestation_8_duration_closed))
mean_12 <- calculate_mean(gestation_12_duration, filter_ca(gestation_12_duration))
mean_12_closed <- calculate_mean(gestation_12_duration_closed, filter_ca(gestation_12_duration_closed))
mean_16 <- calculate_mean(gestation_16_duration, filter_ca(gestation_16_duration))
mean_16_closed <- calculate_mean(gestation_16_duration_closed, filter_ca(gestation_16_duration_closed))
mean_20 <- calculate_mean(gestation_20_duration, filter_ca(gestation_20_duration))
mean_20_closed <- calculate_mean(gestation_20_duration_closed, filter_ca(gestation_20_duration_closed))
...
df <- data.frame(supp=rep(c("Closest", "Second closest"), each=4),
                  ...
                  avg_driving_times=c(as.numeric(mean_8), as.numeric(mean_12), as.numeric(mean_16), as.numeric(mean_20),
                                      as.numeric(mean_8_closed), as.numeric(mean_12_closed), as.numeric(mean_16_closed), as.numeric(mean_20_closed)))

# line_graph
# add first data: solid line
line_graph <- ggplot(df, aes(x = weeks_in_pregnancy, y = avg_driving_times, group = supp)) +
